...
<svg xmlns="http://www.w3.org/2000/svg" style="height:80px;width:240px" viewBox="0 0 240 80" viewbox="0 0 240 80"> <style>rect{ stroke-width:3;stroke:rgb(237,241,248) }</style> <defs> <linearGradient id="a" x2="0" y1="1"> <stop stop-color="#ff1300" offset="0"/> <stop stop-color="#ff2514" offset="1"/> </linearGradient> </defs> <rect x="12" y="4" width="216" height="72" rx="10" fill="url(#a)"/> </svg>
...
https://github.com/user-attachments/assets/bfac60bc-17a8-404f-a0b8-58af020157fb



https://github.com/user-attachments/assets/e12111d6-1f3b-49f8-854e-3b7c63e43578

[Ой у лузі червона калина (гімн стрільців) - Олесь Успіх.mp3](https://github.com/user-attachments/files/28670374/-.mp3)
